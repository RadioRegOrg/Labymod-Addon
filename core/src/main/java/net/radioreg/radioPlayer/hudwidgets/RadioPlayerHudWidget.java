package net.radioreg.radioPlayer.hudwidgets;

import net.radioreg.radioPlayer.Main;
import net.radioreg.radioPlayer.event.station.StreamChangeTrackEvent;
import net.radioreg.radioPlayer.hudwidgets.RadioPlayerHudWidget.RadioRegHudWidgetConfig;
import net.radioreg.radioPlayer.widget.IngameWidget;
